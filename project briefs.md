...
| [19](#team-19) | Logue | 산학 | Logue는 자연어 질문을 SQL로 변환하여 데이터베이스 정보를 조회할 수 있도록 돕는 AI 기반 데이터 질의 웹 인터페이스입니다. SQL을 알지 못하는 사용자도 데이터를 직접 탐색하고 분석할 수 있도록 지원하여 데이터 기반 의사결정을 쉽게 만드는 것을 목표로 합니다. |
...
| 항목 | 내용 |
|------|------|
| 프로젝트명 | Logue는 자연어 질문을 SQL로 변환하여 데이터베이스 정보를 조회할 수 있도록 돕는 AI 기반 데이터 질의 웹 인터페이스입니다. SQL을 알지 못하는 사용자도 데이터를 직접 탐색하고 분석할 수 있도록 지원하여 데이터 기반 의사결정을 쉽게 만드는 것을 목표로 합니다. |
| 트랙 | 산학 |
| 팀명 | Logue |
| 팀구성 | 손하늘, 김겨레, 민지인, 김예원 |
| 팀지도교수 | 하진용 |
...
| Team Ground Rule | [Team Ground Rule](https://github.com/26-ewha-capstone-logue/logs/blob/main/Team_Ground_Rule.md) |
| 최종수정일 | 2026.03.10 13시 38분 |
